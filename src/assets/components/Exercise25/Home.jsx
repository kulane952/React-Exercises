    ...
    <div className='text-center'>
      ...
      <div className='grid md:grid-cols-2 gap-2 max-w-2xl mx-auto'>
        ...
        >
          ...
          <p>Explore our collection delicious recipes</p>
        </Link>
        <Link to='/categories'
        className='bg-rose-600 text-white p-6 rouneded-lg shadow-md hover:bg-rose-700 transition-color'
        >
          <h2 className='text-2xl font-bold mb-2'>Recip Categories</h2>
